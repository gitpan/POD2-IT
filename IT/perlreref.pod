...
Questa è una guida di riferimento rapida alle espressioni 
regolari (regex) in Perl. Per maggiori informazioni vedete  
L<perlre> e L<perlop>, 
e la sezione L</"VEDI ANCHE"> 
...
I quantificatori sono avidi (greedy) per dafult -- trovano il testo B<più lungo> e più a sinistra.
...
Si tratta di un concetto di Unicode che è quasi sempre uguale
a un carattere maiuscolo, ma per certi caratteri come "scharfes s" (&szlig;) in
tedesco c'è una differenza.
...
I<Mastering Regular Expressions> (2nd edition) di Jeffrey Friedl
