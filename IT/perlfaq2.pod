...
perlfaq2 - Ottenere ed Imparare Perl ($Revision: 1.8 $, $Date: 2004/01/12 14:39:33 $)
...
perl) viene distribuita nel solo formato sorgente. E<Eacute> reperibile su
...
=head2 Non ho un compilatore C sul mio sistema. Come posso compilare perl?
...
CPAN significa Comprehensive Perl Archive Network, un archivio di circa
700mb replicato su circa 200 macchine in tutto il mondo. CPAN contiene
codice sorgente, port non nativi, documentazione, script, e molti moduli
di terze parti ed estensioni, progettati per qualsiasi cosa a partire da
...
CPAN non E<egrave> affiliato con O'Reilly and Associates.
...
informato HTML. Tutte le installazioni Perl ben fatto hanno una
...
Se tutto il resto fallisce, consultate http://perldoc.cpan.org/ oppure
http://www.perldoc.com/ . Entrambi offrono la documentazione completa in
formato html.
...
essere altri al momento in cui leggete questo. Anche Le seguenti URL
...
Tom Christiansen mantiene una lista di questi libri, alcuni con un'estesa
recensione su http://www.perl.com/perl/critiques/index.html .

L'incontestabile e definitivo manuale di riferimento sul Perl, scritto dal
creatore del Perl, E<egrave> ora (luglio 2000) alla sua terza edizione:
...
Se siete dei programmatori stagionati allora potrebbe essere sufficiente per
voi imparare il Perl dal Camel. Se non lo siete, acquistate il Llama book
[Libro del lama, NdT]:

    Learning Perl (the "Llama Book")
        di Randal L. Schwartz e Tom Phoenix
        ISBN 0-596-00132-0 [3a edizione luglio 2001]
...
che segue (benchE<eacute> sfortunatamente piuttosto datato).
    ...
    Learning Perl on Win32 Systems (the "Gecko Book" ["Il libro del geco", NdT])
...
=item Di riferimento
    ...
    Perl in a Nutshell
        di Ellen Siever, Stephan Spainhour e Nathan Patwardhan
        ISBN 1-56592-286-7 [1a edizione dicembre 1998]
...
=item Tutorial
    ...
    Cross-Platform Perl
        di Eric Foster-Johnson
        ISBN 1-55851-483-X [2a edizione settembre 2000]
        http://www.pconline.com/~erc/perlbook.htm

     MacPerl: Power and Ease
        di Vicki Brown e Chris Nandor, con prefazione di Matthias Neeracher
        ISBN 1-881957-32-2 [1a edizione maggio 1998]
        http://www.macperl.com/ptf_book/

=item Soluzioni per determinati lavori

    The Perl Cookbook
        di Tom Christiansen e Nathan Torkington con prefazione di Larry Wall
        ISBN 1-56592-243-3 [1a edizione agosto 1998]
...
=head2 Perl sulla Rete: Accesso FTP e WWW

Per ottenere le massime prestazioni, scegliete un sito dalla lista su 
http://www.cpan.org/SITES.html . Da essa potete scegliere
il sito per voi piE<ugrave> veloce.

E<Egrave> anche possibile utilizzare xx.cpan.org, dove "xx" E<egrave>
il codice del dominio della nazione a due lettere; ad esempio l'Australia
usa au.cpan.org. [Nota: ciE<ograve> E<egrave> valido solo per le nazioni
che ospitano almeno un mirror.]
...
=head2 Archivi di comp.lang.perl.misc
...
contrattuali molto seri. CD confezionati contenenti Perl sono disponibili
da varie parti, se ciE<ograve> puE<ograve> aiutare. Per esempio, molti libri
...
sono fornite tutte col Perl.

Alternativamente, si puE<ograve> acquistare un supporto commerciale,
basato sugli incidenti, attraverso The Perl Clinic. Di seguito E<egrave>
riportata una loro nota pubblicitaria:

"The Perl Clinic E<egrave> un servizio di supporto commerciale al Perl
operato da ActiveState Tool Corp. e da The Ingram Group. Gli operatori
hanno un'esperienza approfondita e di molti anni sulle applicazioni e
sugli internal del Perl, su un'ampia serie di sistemi.

"Attraverso il nostro gruppo di ingegneri ben preparati e molto esperti,
faremo del nostro meglio per capire il vostro problema, fornire una
spiegazione della situazione, ed una raccomandazione su come procedere."

Potete contattare The Perl Clinic a:

    www.PerlClinic.com

    Ora Standard del Nord America Pacifico(GMT-8)
    Tel:    1 604 606-4611 orario 8am-6pm
    Fax:    1 604 606-4640
...
Consultate inoltre www.perl.com per aggiornamenti su tutorial, formazione,
e supporto.

=head2 Dove invio le segnalazioni di bug?

Se dovete segnalare un bug dell'interprete perl o dei moduli distribuiti
con il Perl, utilizzate il programma perlbug incluso nella distribuzione,
o inviate la vostra segnalazione a perlbug@perl.org .
...
La Perl Home Page, disponibile all'indirizzo http://www.perl.com/ , E<egrave>
al momento ospitata da The O'Reilly Network, che E<egrave> parte di O'Reilly
and Associates.

I Perl Mongers sono un'organizzazione che sostiene il linguaggio Perl, e
che dispone di un proprio sito alla URL http://www.perl.org/ . Si tratta di
un sito generico di supporto al Perl.

I Perl Monger usano il dominio pm.org per fornire servizi relativi agli user
group (NdT: gruppi di utenti) sul Perl, incluso l'hosting di mailing list e
...
I Perl Mongers inoltre utilizzano il dominio perl.org per fornire un
supporto generico alla comunitE<agrave> Perl, incluso l'hosting di mailing
list, siti web, ed altri servizi. Il sito http://www.perl.org/ E<egrave>
un sito generico di supporto al linguaggio Perl, ed esistono molti altri
sottodomini dedicati al argomenti specifici, come ad esempio:
...
la domanda I<Cos'E<egrave> CPAN?> piE<ugrave> in alto in questo documento.
