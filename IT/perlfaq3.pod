...
perlfaq3 - Strumenti di Programmazione ($Revision: 1.17 $, $Date: 2005/11/19 00:21:49 $)
...
Il sito web del progetto E<egrave> http://e-p-i-c.sf.net/
...
debugging remoto ( http://www.ActiveState.com/Products/Komodo/ ).
