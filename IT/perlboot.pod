...
giE<agrave>, conviene che via familiarizzate con questi argomenti.
...
Urca. Questa deferenziazione di un riferimento simbolico a codice E<egrave> 
piuttosto brutta. Stiamo considerando il comportamento dato da C<no strict subs>, 
...
Questa magica variabile chiamata C<@ISA> (si pronuncia "is a"
[E<egrave> un/una, NdT] non "Isa"), ha dichiarato che C<Mucca>
...
corrente, invocando il primo trovato.
...
Naturalmente, se costruiamo tutto il nostro cavallo a mano, molto
...
Qui, l'operatore C<?:> E<egrave> comodo per selezionare o la deferenziazione,
...
Avere tutti i nostri cavalli di colore marrone sarebbe
noioso. Aggiungiamo dunque un metodo o due per ottenere e modificare il
colore.
