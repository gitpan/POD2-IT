...
Questa formadi chiamata a subroutine E<egrave> deprecata. Consultate L<perlsub>.
...
package per usarla all'itenro dello scope corrente. Quando E<egrave> in
...
compattazioni di directiry, C<seekdir> ha gli stessi avvertimenti della
...
soddisfatte, sappiate che effettuare un unlink su una directory poE<egrave> danneggiare
